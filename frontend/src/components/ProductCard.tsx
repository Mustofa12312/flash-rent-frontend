...
export default function ProductCard({ product, startingPrice }: ProductCardProps) {
  ...
  return (
    <div className="group glass rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 bg-white">
      {product.imageUrl ? (
        ...
        <div className="h-48 bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center p-6 text-center">
