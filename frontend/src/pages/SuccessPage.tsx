...
import { CheckCircle2, Key, ExternalLink, Copy } from 'lucide-react';
        ...
        <div className="bg-slate-900 p-8 rounded-3xl shadow-xl text-white relative overflow-hidden">
          ...
          <div className="space-y-6 relative z-10">
            {product.category === 'Software' || product.category === 'Design' ? (
              <div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button className="p-3 bg-slate-800 hover:bg-slate-700 rounded-xl transition-colors border border-slate-700 text-slate-300">
            ...
            <div className="pt-6 border-t border-slate-800">
              <a href="#" className="flex items-center justify-center w-full py-3 rounded-xl bg-blue-600 hover:bg-blue-500 font-semibold transition-colors">
                Buka Produk <ExternalLink className="w-4 h-4 ml-2" />
              </a>
            </div>
          </div>
        </div>
