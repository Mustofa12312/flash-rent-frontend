    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl shadow-xl border border-slate-100">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-500">Daftar untuk mulai mengelola lisensi Anda</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-slate-600">
          Sudah punya akun?{' '}
          <Link to="/login" className="font-semibold text-blue-600 hover:text-blue-500 inline-flex items-center">
            Masuk di sini <ArrowRight className="w-4 h-4 ml-1" />
          </Link>
        </p>
      </div>
    </div>
